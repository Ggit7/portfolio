...
export const workData = [
    {
        ...
        bgImage:'./work-1.png',
        link:'https://foodie-eight-iota.vercel.app/'
    },
    {
        title: ' store website',
        description: 'web Development',
...
export const infoList = [
    { icon: assets.code_icon, iconDark: assets.code_icon_dark, title: 'Languages', description: 'HTML, CSS, JavaScript React Js, Next Js, Twailwind.css,MUI' },
...
export const toolsData = [
    assets.vscode, assets.react, assets.mongodb, assets.mui, assets.git, assets.bootstrap
];